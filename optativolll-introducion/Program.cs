...
string connectionString = "Host=localhost;port=5432;Database=optativoIII;Username=postgres;Password=steamat10;";
...
if (opcion == "b")
{
    ...
    clienteservices.listado().ForEach(Cliente =>
...
else if (opcion == "c")
{
    ...
    try
    {
        ...
        bool actualizado = clienteservices.ActualizarCliente(clienteExistente);
